...
4. Give it a name (e.g., "TeamAgents Agent") and choose permissions:
...
7. Note: You'll also need to verify a domain to send emails from custom addresses""",
    ...
    "google": CredentialSpec(
        ...
        required=True,
        startup_required=False,
        help_url="https://teamagents.adenhq.com",
        description=(
        ...
        api_key_instructions="Google OAuth requires OAuth2. Connect via teamagents.adenhq.com",
